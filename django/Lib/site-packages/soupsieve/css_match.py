...
class _DocumentNav(object):
    ...
    def get_text(self, el, no_iframe=False):
        ...
        return "".join(
            [
                node
                for node in self.get_descendants(el, tags=False, no_iframe=no_iframe)
...
class _Match(object):
    ...
    def find_bidi(self, el):
        ...
        for node in self.get_children(el, tags=False):
            ...
            if self.is_tag(node):
                ...
                if (
                    self.get_tag(node)
                    in ("bdi", "script", "style", "textarea", "iframe")
    ...
    def match_lang(self, el, langs):
        ...
        if found_lang is None and (
            not self.is_xml or (has_html_namespace and root.name == "html")
        ):
            # Find head
            found = False
...
class SoupSieve(ct.Immutable):
    ...
    def __repr__(self):  # pragma: no cover
        ...
        return (
            "SoupSieve(pattern={!r}, namespaces={!r}, custom={!r}, flags={!r})".format(
